      ...
      <div className="max-w-2xl mx-auto p-2 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to IMDB Mirror! This app is designed to provide users with
              a comprehensive database of movies,TV shows, and entertainment
              content. Our goal is to offer a seamless ad enjoyable experience
              for movie ethusiasts and casual viewers alike.
            </p>
            <p>
              On IMDB Mirror, you&apos;ll find detailed information about your
